package com.jlfr.tresxtres.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.jlfr.tresxtres.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.jlfr.tresxtres.repository.UserRepository.USERS_BY_EMAIL_CACHE);
